    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside x-show="sidebarOpen || mobileSidebar" x-cloak
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <x-admin.sidebar-item href="{{ route('mahasiswa.forum.index') }}" :active="request()->routeIs('mahasiswa.forum.*')" icon="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z">Forum</x-admin.sidebar-item>
                <x-admin.sidebar-item href="{{ route('mahasiswa.chat.index') }}" :active="request()->routeIs('mahasiswa.chat.*')" icon="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z">Chat</x-admin.sidebar-item>
                <x-admin.sidebar-item href="{{ route('mahasiswa.calendar.index') }}" :active="request()->routeIs('mahasiswa.calendar.*')" icon="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">Kalender</x-admin.sidebar-item>
